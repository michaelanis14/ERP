...
void PurchaseSerialUI::ShowUI() { 
 ...
 if( !ErpModel::GetInstance()->UserAccessList.at(0)->PurchaseSerial) 
...
else{ QMessageBox::warning(this, QObject::tr("PurchaseSerial"),errorString.trimmed());
return false; 
 }
}
...
else{ if(!errorString.trimmed().isEmpty()) QMessageBox::warning(this, QObject::tr("PurchaseSerial"),errorString.trimmed());
return false; 
 }
}

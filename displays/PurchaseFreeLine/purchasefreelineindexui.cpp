...
ERPFormBlock* block0Layout = new ERPFormBlock; 
 ...
 QObject::connect(tabel->selectionModel(), &QItemSelectionModel::selectionChanged, this, &PurchaseFreeLineIndexUI::onSelectionChanged);
...
void PurchaseFreeLineIndexUI::ShowUI() { 
 ...
 PurchaseFreeLineIndexUI::GetUI()->model->refresh();	
...
void PurchaseFreeLineIndexUI::addRow(){ 
 ...
 PurchaseFreeLineUI::GetUI()->fill(new PurchaseFreeLine()); 
 }
void PurchaseFreeLineIndexUI::editRow(){ 
 PurchaseFreeLineUI::ShowUI(); 
 PurchaseFreeLineUI::GetUI()->fill(model->get(tabel->selectionModel()->selectedRows().last())); 
 }

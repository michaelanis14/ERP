...
ERPFormBlock* block0Layout = new ERPFormBlock; 
 ...
 QObject::connect(tabel->selectionModel(), &QItemSelectionModel::selectionChanged, this, &ProjectIndexUI::onSelectionChanged);
...
void ProjectIndexUI::ShowUI() { 
 ...
 ProjectIndexUI::GetUI()->model->refresh();	
...
void ProjectIndexUI::editRow(){ 
 ProjectUI::ShowUI(); 
 ProjectUI::GetUI()->fill(model->get(tabel->selectionModel()->selectedRows().last())); 
 }

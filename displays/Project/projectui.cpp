...
ProjectUI::ProjectUI(QWidget *parent) :ERPDisplay(parent)
{
	...
	willbeinvoiced->setChecked(true);
...
void ProjectUI::addTask(){
	...
	taskui->contactperson->addItems(ContactPerson::GetPairList((ContactPerson::QuerySelect("ContactID = "+QString::number(this->contact->getKey())))));
	Tasks.append(taskui);
...
void ProjectUI::addProjectContactPerson(){
	...
	projectcontactpersonui->contactperson->addItems(ContactPerson::GetPairList((ContactPerson::QuerySelect("ContactID = "+QString::number(this->contact->getKey())))));
...
void ProjectUI::selectionChanged(QString){
foreach(ProjectContactPersonUI* projectContactPersonUI,ProjectContactPersons){
	projectContactPersonUI->contactperson->addItems(ContactPerson::GetPairList((ContactPerson::QuerySelect("ContactID = "+QString::number(this->contact->getKey())))));

}
foreach(TaskUI* taskui,Tasks){
	taskui->contactperson->addItems(ContactPerson::GetPairList((ContactPerson::QuerySelect("ContactID = "+QString::number(this->contact->getKey())))));
}
}

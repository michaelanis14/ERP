...
ERPFormBlock* block0Layout = new ERPFormBlock; 
 ...
 QObject::connect(tabel->selectionModel(), &QItemSelectionModel::selectionChanged, this, &ProductFieldDataIndexUI::onSelectionChanged);
...
void ProductFieldDataIndexUI::ShowUI() { 
 ...
 ProductFieldDataIndexUI::GetUI()->model->refresh();	
...
void ProductFieldDataIndexUI::editRow(){ 
 ProductFieldDataUI::ShowUI(); 
 ProductFieldDataUI::GetUI()->fill(model->get(tabel->selectionModel()->selectedRows().last())); 
 }

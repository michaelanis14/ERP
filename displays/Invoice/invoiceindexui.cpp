...
ERPFormBlock* block0Layout = new ERPFormBlock; 
 ...
 QObject::connect(tabel->selectionModel(), &QItemSelectionModel::selectionChanged, this, &InvoiceIndexUI::onSelectionChanged);
...
void InvoiceIndexUI::ShowUI() { 
 ...
 InvoiceIndexUI::GetUI()->model->refresh();	
...
void InvoiceIndexUI::editRow(){ 
 InvoiceUI::ShowUI(); 
 InvoiceUI::GetUI()->fill(model->get(tabel->selectionModel()->selectedRows().last())); 
 }

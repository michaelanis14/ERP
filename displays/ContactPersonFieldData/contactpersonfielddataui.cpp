...
contactpersonfield->addItems(ContactPersonField::GetHashList());
...
if(ContactPersonFieldData::GetStringList().contains(value->text()))
{
ContactPersonFieldData* con = ContactPersonFieldData::Get(value->text());

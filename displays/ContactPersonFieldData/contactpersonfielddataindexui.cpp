...
ERPFormBlock* block0Layout = new ERPFormBlock; 
 ...
 QObject::connect(tabel->selectionModel(), &QItemSelectionModel::selectionChanged, this, &ContactPersonFieldDataIndexUI::onSelectionChanged);
...
void ContactPersonFieldDataIndexUI::ShowUI() { 
 ...
 ContactPersonFieldDataIndexUI::GetUI()->model->refresh();	
...
void ContactPersonFieldDataIndexUI::addRow(){ 
 ...
 ContactPersonFieldDataUI::GetUI()->fill(new ContactPersonFieldData()); 
 }
void ContactPersonFieldDataIndexUI::editRow(){ 
 ContactPersonFieldDataUI::ShowUI(); 
 ContactPersonFieldDataUI::GetUI()->fill(model->get(tabel->selectionModel()->selectedRows().last())); 
 }

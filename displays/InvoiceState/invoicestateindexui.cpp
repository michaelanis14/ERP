...
ERPFormBlock* block0Layout = new ERPFormBlock; 
 ...
 QObject::connect(tabel->selectionModel(), &QItemSelectionModel::selectionChanged, this, &InvoiceStateIndexUI::onSelectionChanged);
...
void InvoiceStateIndexUI::ShowUI() { 
 ...
 InvoiceStateIndexUI::GetUI()->model->refresh();	
...
void InvoiceStateIndexUI::addRow(){ 
 ...
 InvoiceStateUI::GetUI()->fill(new InvoiceState()); 
 }
void InvoiceStateIndexUI::editRow(){ 
 InvoiceStateUI::ShowUI(); 
 InvoiceStateUI::GetUI()->fill(model->get(tabel->selectionModel()->selectedRows().last())); 
 }

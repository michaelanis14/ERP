...
ERPFormBlock* block0Layout = new ERPFormBlock; 
 ...
 QObject::connect(tabel->selectionModel(), &QItemSelectionModel::selectionChanged, this, &DeliveryOrderIndexUI::onSelectionChanged);
...
void DeliveryOrderIndexUI::ShowUI() { 
 ...
 DeliveryOrderIndexUI::GetUI()->model->refresh();	
...
void DeliveryOrderIndexUI::editRow(){ 
 DeliveryOrderUI::ShowUI(); 
 DeliveryOrderUI::GetUI()->fill(model->get(tabel->selectionModel()->selectedRows().last())); 
 }

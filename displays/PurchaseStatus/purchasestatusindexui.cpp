...
ERPFormBlock* block0Layout = new ERPFormBlock; 
 ...
 QObject::connect(tabel->selectionModel(), &QItemSelectionModel::selectionChanged, this, &PurchaseStatusIndexUI::onSelectionChanged);
...
void PurchaseStatusIndexUI::ShowUI() { 
 ...
 PurchaseStatusIndexUI::GetUI()->model->refresh();	
...
void PurchaseStatusIndexUI::editRow(){ 
 PurchaseStatusUI::ShowUI(); 
 PurchaseStatusUI::GetUI()->fill(model->get(tabel->selectionModel()->selectedRows().last())); 
 }

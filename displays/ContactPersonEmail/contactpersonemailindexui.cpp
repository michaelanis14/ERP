...
ERPFormBlock* block0Layout = new ERPFormBlock; 
 ...
 QObject::connect(tabel->selectionModel(), &QItemSelectionModel::selectionChanged, this, &ContactPersonEmailIndexUI::onSelectionChanged);
...
void ContactPersonEmailIndexUI::ShowUI() { 
 ...
 ContactPersonEmailIndexUI::GetUI()->model->refresh();	
...
void ContactPersonEmailIndexUI::editRow(){ 
 ContactPersonEmailUI::ShowUI(); 
 ContactPersonEmailUI::GetUI()->fill(model->get(tabel->selectionModel()->selectedRows().last())); 
 }

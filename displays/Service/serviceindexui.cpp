...
ERPFormBlock* block0Layout = new ERPFormBlock; 
 ...
 QObject::connect(tabel->selectionModel(), &QItemSelectionModel::selectionChanged, this, &ServiceIndexUI::onSelectionChanged);
...
void ServiceIndexUI::ShowUI() { 
 ...
 ServiceIndexUI::GetUI()->model->refresh();	
...
void ServiceIndexUI::editRow(){ 
 ServiceUI::ShowUI(); 
 ServiceUI::GetUI()->fill(model->get(tabel->selectionModel()->selectedRows().last())); 
 }

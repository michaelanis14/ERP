...
ERPFormBlock* block0Layout = new ERPFormBlock; 
 ...
 QObject::connect(tabel->selectionModel(), &QItemSelectionModel::selectionChanged, this, &DeliveryOrderStoreProductIndexUI::onSelectionChanged);
...
void DeliveryOrderStoreProductIndexUI::ShowUI() { 
 ...
 DeliveryOrderStoreProductIndexUI::GetUI()->model->refresh();	
...
void DeliveryOrderStoreProductIndexUI::addRow(){ 
 ...
 DeliveryOrderStoreProductUI::GetUI()->fill(new DeliveryOrderStoreProduct()); 
 }
void DeliveryOrderStoreProductIndexUI::editRow(){ 
 DeliveryOrderStoreProductUI::ShowUI(); 
 DeliveryOrderStoreProductUI::GetUI()->fill(model->get(tabel->selectionModel()->selectedRows().last())); 
 }

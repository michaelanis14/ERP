...
if(id != 0) {
QSqlQuery query = (ErpModel::GetInstance()->qeryExec("SELECT * FROM ProductFieldData WHERE ProductFieldDataID = '"+QString::number(id)+"'"));
while (query.next()) {
...
QHash<int,QString> ProductFieldData::GetHashList() {

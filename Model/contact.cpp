...
this->setRelation(12, QSqlRelation("ContactStatus", "ContactStatusID", "Description"));
this->setRelation(13, QSqlRelation("Employee", "EmployeeID", "Name"));
}
Contact::Contact(int ContactID,QString Name,QString Salutation,QString BirthdateOrDateOfFoundation,int ContactTypeID,int ContactClassID,int Serial,QString Address,QString PostalCode,QString City,QString BlaBlaBla,int CountryID,int ContactStatusID,int EmployeeID,QString Website,QString TaxNumber,QString CreatedOn,QString EditedOn) : QSqlRelationalTableModel(){
...
Contact::Contact(QString Name,QString Salutation,QString BirthdateOrDateOfFoundation,int ContactTypeID,int ContactClassID,int Serial,QString Address,QString PostalCode,QString City,QString BlaBlaBla,int CountryID,int ContactStatusID,int EmployeeID,QString Website,QString TaxNumber,QString CreatedOn,QString EditedOn) : QSqlRelationalTableModel(){
this->ContactID = 0 ;
this->Name = Name ;
this->Salutation = Salutation ;
this->BirthdateOrDateOfFoundation = BirthdateOrDateOfFoundation ;
...
while (query.next()) {
return new Contact(query.value(0).toInt(),query.value(1).toString(),query.value(2).toString(),query.value(3).toString(),query.value(4).toInt(),query.value(5).toInt(),query.value(6).toInt(),query.value(7).toString(),query.value(8).toString(),query.value(9).toString(),query.value(10).toString(),query.value(11).toInt(),query.value(12).toInt(),query.value(13).toInt(),query.value(14).toString(),query.value(15).toString(),query.value(16).toString(),query.value(17).toString());
 }
...
QList<Contact*> Contact::GetAll() {
	...
	while (query.next()) {
contacts.append(new Contact(query.value(0).toInt(),query.value(1).toString(),query.value(2).toString(),query.value(3).toString(),query.value(4).toInt(),query.value(5).toInt(),query.value(6).toInt(),query.value(7).toString(),query.value(8).toString(),query.value(9).toString(),query.value(10).toString(),query.value(11).toInt(),query.value(12).toInt(),query.value(13).toInt(),query.value(14).toString(),query.value(15).toString(),query.value(16).toString(),query.value(17).toString()));
	}
	return contacts;
}
...
while (query.next()) {
contact = new Contact(query.value(0).toInt(),query.value(1).toString(),query.value(2).toString(),query.value(3).toString(),query.value(4).toInt(),query.value(5).toInt(),query.value(6).toInt(),query.value(7).toString(),query.value(8).toString(),query.value(9).toString(),query.value(10).toString(),query.value(11).toInt(),query.value(12).toInt(),query.value(13).toInt(),query.value(14).toString(),query.value(15).toString(),query.value(16).toString(),query.value(17).toString());
 }
...
while (query.next()) {
list.append(new Contact(query.value(0).toInt(),query.value(1).toString(),query.value(2).toString(),query.value(3).toString(),query.value(4).toInt(),query.value(5).toInt(),query.value(6).toInt(),query.value(7).toString(),query.value(8).toString(),query.value(9).toString(),query.value(10).toString(),query.value(11).toInt(),query.value(12).toInt(),query.value(13).toInt(),query.value(14).toString(),query.value(15).toString(),query.value(16).toString(),query.value(17).toString()));
 }
...
if (
index.column() == 1 || index.column() == 2 || index.column() == 3 || index.column() == 4 || index.column() == 5 || index.column() == 6 || index.column() == 7 || index.column() == 8 || index.column() == 9 || index.column() == 10 || index.column() == 11 || index.column() == 12 || index.column() == 13 || index.column() == 14 || index.column() == 15 || index.column() == 19 || index.column() == 20)
flags |= Qt::ItemIsEditable;
return flags;
}
...
ok = setBlaBlaBla(id, value.toString());
...
this->setHeaderData(10, Qt::Horizontal, QObject::tr("Bla Bla Bla"));
this->setHeaderData(11, Qt::Horizontal, QObject::tr("Country"));
this->setHeaderData(12, Qt::Horizontal, QObject::tr("Contact Status"));
this->setHeaderData(13, Qt::Horizontal, QObject::tr("Employee"));
this->setHeaderData(14, Qt::Horizontal, QObject::tr("Website"));
this->setHeaderData(15, Qt::Horizontal, QObject::tr("Tax Number"));
...
bool Contact::setBlaBlaBla(int ContactID, const QString &BlaBlaBla) {
QSqlQuery query;
query.prepare("update Contact set BlaBlaBla = ? where ContactID = ?");
query.addBindValue(BlaBlaBla);
query.addBindValue(ContactID);
if( !query.exec() )
qDebug() << query.lastError().text();
return true;
